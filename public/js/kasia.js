...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $(function() {
            function mmenuInit() {
                ...
                if (wi <= '1195') {
                    ...
                    $(".mmenu-trigger").on('click', { passive: true }, function() {
                        mmenuAPI.open();
                    });
            ...
            mmenuInit();
            $(window).resize({ passive: true }, function() { mmenuInit(); });
        });
        ...
        function stickyHeader() {
            ...
            $(window).on('scroll load', { passive: true }, function() {
        ...
        $('.logo-carousel').slick({ passive: true }, {
            infinite: true,
            slidesToShow: 5,
            slidesToScroll: 1,
            dots: false,
